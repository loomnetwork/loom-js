...
var GatewayUser = /** @class */ (function (_super) {
    ...
    function GatewayUser(wallet, client, address, ethAddress, gateway, loomToken, vmc, dappchainGateway, dappchainLoom, dappchainMapper, version) {
        ...
        // @ts-ignore
        _this._ethereumGateway = gateway;
        // @ts-ignore
        _this._ethereumLoom = loomToken;
        // @ts-ignore
        _this._ethereumVMC = vmc;
    ...
    GatewayUser.createGatewayOfflineUserAsync = function (endpoint, privateKey, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, GatewayUser.createGatewayUserAsync(wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version)];
            });
        });
    };
    GatewayUser.createGatewayMetamaskUserAsync = function (web3, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var wallet;
            return tslib_1.__generator(this, function (_a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3: 
                    // @ts-ignore
                    return [2 /*return*/, { gateway: gateway, loomToken: loomToken, vmc: vmc }];
                }
            });
        });
    };
    ...
    GatewayUser.createEthSignMetamaskGatewayUserAsync = function (web3, dappchainEndpoint, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var gwVersion, crosschain, dappchainLoom, dappchainGateway, _a, gateway, loomToken, vmc;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        gwVersion = GatewayUser.getGatewayVersion(dappchainEndpoint, version);
                        return [4 /*yield*/, crosschain_user_1.CrossChainUser.createEthSignMetamaskCrossChainUserAsync(web3, dappchainEndpoint, chainId)];
                    case 1:
                        crosschain = _b.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, GatewayUser.getContracts(crosschain.wallet, gatewayAddress, version)];
                    case 4:
                        _a = _b.sent(), gateway = _a.gateway, loomToken = _a.loomToken, vmc = _a.vmc;
                        return [2 /*return*/, new GatewayUser(crosschain.wallet, crosschain.client, crosschain.loomAddress, crosschain.ethAddress, gateway, loomToken, vmc, dappchainGateway, dappchainLoom, null, gwVersion)];
                }
            });
        });
    };
    GatewayUser.createGatewayUserAsync = function (wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var gwVersion, crosschain, dappchainLoom, dappchainGateway, _a, gateway, loomToken, vmc;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        gwVersion = GatewayUser.getGatewayVersion(dappchainEndpoint, version);
                        return [4 /*yield*/, crosschain_user_1.CrossChainUser.createCrossChainUserAsync(wallet, dappchainEndpoint, dappchainKey, chainId)];
                    case 1:
                        crosschain = _b.sent();
                        return [4 /*yield*/, contracts_1.Coin.createAsync(crosschain.client, crosschain.loomAddress)];
                    case 2:
                    ...
                    case 3:
                        dappchainGateway = _b.sent();
                        return [4 /*yield*/, GatewayUser.getContracts(wallet, gatewayAddress, version)];
                    case 4:
                        _a = _b.sent(), gateway = _a.gateway, loomToken = _a.loomToken, vmc = _a.vmc;
                        return [2 /*return*/, new GatewayUser(wallet, crosschain.client, crosschain.loomAddress, crosschain.ethAddress, gateway, loomToken, vmc, dappchainGateway, dappchainLoom, crosschain.addressMapper, gwVersion)];
                }
            });
        });
    };
    ...
    GatewayUser.prototype.depositAsync = function (amount) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var currentApproval, _a, _b, currentApprovalBN, tx, bal, tx2, amt;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        _c.label = 5;
                    case 5: return [4 /*yield*/, this._ethereumLoom.functions.balanceOf(this.ethAddress)];
                    case 6:
                        bal = _c.sent();
                        log("LOOM TOKEN BALANCE", bal.toString());
                        log("AMOUNT TO DEPOSIT", amount.toString());
                        log("GATEWAY ADDRESS", this._ethereumGateway.address);
                        return [4 /*yield*/, this._ethereumLoom.functions.transfer(this._ethereumGateway.address, amount.toString(), { gasLimit: 100000 })];
                    case 7:
                        tx2 = _c.sent();
                        return [4 /*yield*/, tx2.wait()];
                    case 8:
                        _c.sent();
                        return [4 /*yield*/, this._ethereumGateway.getERC20(this._ethereumLoom.address)];
                    case 9:
                        amt = _c.sent();
                        console.log('AMT HEDL BY GATEWAY', amt);
                        return [2 /*return*/, this._ethereumGateway.functions.depositERC20(amount.toString(), this._ethereumLoom.address, { gasLimit: 400000 })];
                }
            });
        });
    };
