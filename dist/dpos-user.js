...
var DPOSUser = /** @class */ (function (_super) {
    ...
    function DPOSUser(wallet, client, address, ethAddress, gateway, loomToken, vmc, dappchainGateway, dappchainLoom, dappchainDPOS, dappchainMapper, version) {
        ...
        var _this = _super.call(this, wallet, client, address, ethAddress, gateway, loomToken, vmc, dappchainGateway, dappchainLoom, dappchainMapper, version) || this;
    ...
    DPOSUser.createEthSignMetamaskUserAsync = function (web3, dappchainEndpoint, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, gateway_user_1.GatewayUser.createEthSignMetamaskGatewayUserAsync(web3, dappchainEndpoint, chainId, gatewayAddress, version)];
                    case 1:
                        gatewayUser = _a.sent();
    ...
    DPOSUser.createUserAsync = function (wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, gateway_user_1.GatewayUser.createGatewayUserAsync(wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, version)];
                    case 1:
                        gatewayUser = _b.sent();
