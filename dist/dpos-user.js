...
var VMCABI = require('./mainnet-contracts/ValidatorManagerContract.json');
var DPOSUser = /** @class */ (function () {
    function DPOSUser(wallet, client, address, ethAddress, gatewayAddress, loomAddress, dappchainGateway, dappchainLoom, dappchainDPOS, dappchainMapper, vmcAddress) {
        this._wallet = wallet;
        this._address = address;
        this._ethAddress = ethAddress;
        this._client = client;
        var gatewayABI = ERC20GatewayABI_v2;
        // @ts-ignore
        ...
        if (vmcAddress) {
            // @ts-ignore
            this._ethereumVMC = new ethers_1.ethers.Contract(vmcAddress, VMCABI, wallet);
        }
    ...
    DPOSUser.createOfflineUserAsync = function (endpoint, privateKey, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, loomAddress, vmcAddress) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, DPOSUser.createUserAsync(wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, loomAddress, vmcAddress)];
            });
        });
    };
    DPOSUser.createMetamaskUserAsync = function (web3, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, loomAddress, vmcAddress) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var provider, wallet;
            return tslib_1.__generator(this, function (_a) {
    ...
    DPOSUser.createUserAsync = function (wallet, dappchainEndpoint, dappchainKey, chainId, gatewayAddress, loomAddress, vmcAddress) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, client, address, ethAddress, dappchainLoom, dappchainGateway, dappchainMapper, dappchainDPOS;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, new DPOSUser(wallet, client, address, ethAddress, gatewayAddress, loomAddress, dappchainGateway, dappchainLoom, dappchainDPOS, dappchainMapper, vmcAddress)];
                }
            });
        });
    };
    ...
    DPOSUser.prototype.withdrawCoinFromRinkebyGatewayAsync = function (amount, sig) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var vs, rs, ss, indexes, sigs, withdrawalHash, validators, i, hash, recAddress, s;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        vs = [];
                        ...
                        ss = [];
                        indexes = [];
                        sigs = sig.slice(2).match(/.65}/g);
                        return [4 /*yield*/, this.getWithdrawalMsg(amount)];
                    case 1:
                        withdrawalHash = _a.sent();
                    ...
                    case 2:
                        ...
                        // Store the ordering of the validators' signatures in `indexes`
                        for (i in sigs) {
                            hash = ethers_1.ethers.utils.arrayify(ethers_1.ethers.utils.hashMessage(ethers_1.ethers.utils.arrayify(withdrawalHash)));
                            recAddress = ethers_1.ethers.utils.recoverAddress(hash, sigs[i]);
                            indexes.push(validators.indexOf(recAddress));
                            s = ethers_1.ethers.utils.splitSignature(sigs[i]);
                            vs.push(s.v);
                            rs.push(s.r);
                            ss.push(s.s);
                        }
                        return [2 /*return*/, this._ethereumGateway.functions.withdrawERC20(amount.toString(), this._ethereumLoom.address, indexes, vs, rs, ss)];
                }
            });
        });
    };
    // Create message so that we can recover and order validators
    DPOSUser.prototype.getWithdrawalMsg = function (amount) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        nonce = _a.sent();
                        amountHashed = ethers_1.ethers.utils.solidityKeccak256(['uint256', 'address'], [amount, this.ethereumLoom.address]);
