 ...
 *
 */
tape_1.default('LoomProvider', function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var client, privKey, fromAddr, loomProvider, contractData, result, contractAddress, id, msg, signResult, hash, _a, r, s, v, pubKey, privateHash, netVersionResult, ethAccountsResult, ethNewBlockFilterResult, ethBlockNumber, ethNewBlockByNumberResult, ethNewBlockByNumberResultLatest, ethSendTransactionResult, contractDataToDeploy, ethSendTransactionDeployResult, ethGetCodeResult, ethCallResult, ethGetTransactionReceiptResult, ethGetTransactionByHashResult, ethSubscribeResult, ethUninstallFilter, err_1;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                _a = ethereumjs_util_1.fromRpcSig(signResult.result), r = _a.r, s = _a.s, v = _a.v;
            ...
            case 3:
                ...
                t.deepEqual(netVersionResult, { id: 1, jsonrpc: '2.0', result: client.chainId }, 'net_version should match the chain id');
                return [4 /*yield*/, helpers_1.execAndWaitForMillisecondsAsync(loomProvider.sendAsync({
                        id: id,
                        method: 'eth_accounts'
                    }))];
