...
var Client = /** @class */ (function (_super) {
     ...
     */
    Client.prototype.getEvmTxReceiptAsync = function (txHashArr) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var txHash, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txHash = crypto_utils_1.Uint8ArrayToB64(txHashArr);
                        debugLog("Get EVM receipt for " + txHash);
                        return [4 /*yield*/, this._readClient.sendAsync('evmtxreceipt', {
                                txHash: txHash
                            })];
                    case 1:
                        result = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._readClient.sendAsync('getevmblockbyhash', {
                                hash: hash,
                                full: full
                            })];
                    case 1:
