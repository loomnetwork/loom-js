...
var TX_ALREADY_EXISTS_ERROR = 'Tx already exists in cache';
...
var Client = /** @class */ (function (_super) {
    ...
    Client.prototype.commitTxAsync = function (tx, opts) {
        if (opts === void 0) { opts = {}; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, middleware, txBytes, i, result, err_1, results, i;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        err_1 = _b.sent();
                        if ((err_1 instanceof Error && err_1.message.indexOf(TX_ALREADY_EXISTS_ERROR) !== -1) || // HTTP
                            (err_1.data && err_1.data.indexOf(TX_ALREADY_EXISTS_ERROR) !== -1) // WS
                        ) {
