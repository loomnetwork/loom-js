...
declare module 'eosjs-ecc' {
  ...
  declare function signHash(data: string | Buffer, privateKey: any, encoding: string = 'utf-8'): string;
  declare function sha256(data: string | Buffer, resultEncoding: string = 'hex', encoding: string = 'hex'): string
}
